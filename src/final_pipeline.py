...
class DirectorStyleTransfer:
    ...
    #             # Apply White Preservation for IDT Video Mode
    #             # (Standard methods are handled inside process_frame, but IDT video mode 
    #             #  calculates 'processed' manually above, so we must apply it here)
